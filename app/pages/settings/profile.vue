<template>
  <UForm :state="state" :schema="schema" @submit.prevent="saveProfile">
    ...
    <UFormGroup class="mb-4" label="Email" name="email" help="You will receive a confirmation email on both the old and the new adresses if you modify the email address">
